...
func TestDebounceWithTimeout(t *testing.T) {
	var (
		counter1 uint64
		counter2 uint64
	)
	...
	debounced := NewWithTimeout(100*time.Millisecond, 300*time.Millisecond)
	...
	if c2 != 3 {
		t.Error("Expected count 3, was", c2)
	}
}

func TestDebounceWithTimeoutConcurrentAdd(t *testing.T) {
...
func TestDebounceWithTimeoutDelayed(t *testing.T) {
	var counter1 uint64
...
func BenchmarkDebounceWithTimeout(b *testing.B) {
	var counter uint64
